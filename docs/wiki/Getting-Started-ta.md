...
**மொழிகள்:** [English](Getting-Started) · **தமிழ்**
...
- [கட்டமைப்பு](Architecture-ta) — ஒவ்வொரு பகுதியும் உண்மையில் என்ன செய்கிறது
- [CLI கையேடு](CLI-Reference-ta) — ஒவ்வொரு கட்டளையும் flag-உம்
- [கிளவுட் நிறுவல்](Cloud-Deployment-ta) — அதே தொகுப்பு Kubernetes-இல்
- [சிக்கல் தீர்வு](Troubleshooting-ta) — மேலே உள்ள படி திட்டப்படி நடக்காதபோது
