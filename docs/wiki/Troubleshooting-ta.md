...
**மொழிகள்:** [English](Troubleshooting.html) · **தமிழ்**
...
உங்களுடையது அல்லாத `/Users/…` அல்லது `/home/…` பாதையுடன் சோதனை தோல்வியடைந்தால், அது யாரோ ஒருவரின் கணினியை நேரடியாக எழுதி வைத்திருக்கிறது. அதற்குப் பதிலாக `t.TempDir()` அல்லது `repoRoot(t)` பயன்படுத்துங்கள் — [சோதனை](Testing-ta.html) பார்க்கவும்.
